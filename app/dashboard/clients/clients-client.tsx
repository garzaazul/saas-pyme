...
export function ClientsClient({
    ...
    const [newClientsThisMonth, setNewClientsThisMonth] = useState(initialNewThisMonth);
    ...
    // loadData solo se llama DESPUÉS de mutaciones para refrescar
