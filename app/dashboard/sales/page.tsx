            ...
            <div className="grid gap-6 md:grid-cols-3">
                ...
                <Card className="premium-shadow border-none bg-white dark:bg-slate-900 overflow-hidden group">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <FileText className="h-4 w-4 text-[#091226]" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-black tracking-tight leading-none">12</div>
                        <p className="text-xs font-bold text-[#091226] mt-2 italic shadow-sm bg-[#091226]/5 dark:bg-white/10 inline-block px-2 py-0.5 rounded-full">Formalidad: 85%</p>
                    </CardContent>
                </Card>
